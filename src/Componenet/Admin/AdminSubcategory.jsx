            ...
            <div className="contain-fluid my-5">
                <div className="row">
                    ...
                    <div className="col-lg-10 col-12">
                        <h5 className='bg-secondary text-center text-light p-1'>Subategory <Link to="/admin-add-subcategory" className='float-right'><span className="material-symbols-outlined text-light">add</span></Link></h5>
